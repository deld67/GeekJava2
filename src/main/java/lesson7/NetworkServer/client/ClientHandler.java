package lesson7.NetworkServer.client;

import lesson7.NetworkServer.NetworkServer;
    ...
    private void readMessages() throws IOException {
        while (true) {
            ...
            if (message.startsWith("/w")) {
                ...
                String toUsername = messageParts[1];
                message = messageParts[2];
                networkServer.personalMessage(toUsername, message, this);
            }else {
